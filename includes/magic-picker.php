...
<div class="magic-pick" style="display:none;">
	...
	<div class="right-col" style="float:right;width:500px;max-width:100%;">
		<h3>Sample Output</h3>
		<div style="margin:20px;border:3px solid #000;max-height:300px;height:300px;padding:20px;box-sizing:border-box;overflow:scroll;">
